...
1. Wofür Daten zur Nutzung von offenen Daten publizieren?
2. Woher kommen die Daten?
3. Das Webanalytics-Dashboard
4. Ausblick & geplante Änderungen
...
Datensatzbeschreibungen etc.

https://handbook.opendata.swiss/support/api.html


### opendata.swiss Matomo Webanalytics API

--> opendata.swiss

matomo api unseres Webservers / CMS
...
Sowohl Aufbereitung / ogd Dashboard!
