...
Spurensuche mit Hilfe von Webanalytics --> keine direkten Schlüsse bezüglich der Motive, aber allenfalls Indizien.
...
Die Analyse der Nutzungsdaten soll es uns ermöglichen, besser fundierte Entscheide betreffend der Weiterentwicklung unseres Datenangebots zu fällen. Um die Daten einfach analysieren zu können müssen wir diese aufbereiten. Den dementsprechenden Datensatz stellen wir seit Februar 2019 monatlich 1:1 als opendata zur Verfügung.
...
__R-Code für die Aufbereitung :__ <a href="https://github.com/openZH/web-analytics-der-open-government-data-des-kantons-zuerich"><i class="fa fa-github fa-fw"></i>openzh_webanalytics</a>

???

Das Verhalten auf unserem Webauftritt kann uns helfen, Bedürfnisse zu identifizieren und besser zu verstehen. Ziel ist, dass wir Entscheide nicht auf Grundlage von un- oder schwach belegten Annahmen treffen; und dass wir unsere Informations- und Dienstleistungen gemäss den sich wandelnden Bedürfnissen erbringen können.

Was kann aus den Daten gelesen - in der jetzigen Form - geselen werden? Wie oft unsere Datensätze auf Opendata.swiss aufgerufen wurden - d.h. wieviel Aufmerksamkeit sie erhalten haben. Nimmt das Interesse an den Daten zu? Welche Datensätze interessieren am meisten? Welche Themen? 
...
⇒ offen zugängliche Schnittstelle: https://handbook.opendata.swiss/support/api.html
]
